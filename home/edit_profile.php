...
<div class="main-container ace-save-state" id="main-container">
  ...
  if (isset($_POST['password'])) {
    ...
    if ($rows == 1) {
      $passwordnew = md5($_POST['passwordnew'] . 'hoangtung!1');
      $query2 = "UPDATE user SET password = '" . $passwordnew . "' WHERE  username = '" . $username . "'";
  ...
  ?>
    ...
    <form class="col-sm-3 control-label no-padding-right" action="./edit_profile.php" method="post">
        <div class="space-4"><label class="col-sm-3 control-label no-padding-right"
                                    for="form-field-2"> <?php echo $thongbao; ?></label></div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="password" name="passwordnew" id="passwordnew" placeholder="Mật khẩu mới"
                       class="col-xs-10 col-sm-5"/>
                <span class="help-inline col-xs-12 col-sm-7">
											</span>
            </div>
