    ...
    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form class="form-horizontal" role="form" name="themcongnhan"
                                      action="./edit_phieuthu.php" onsubmit="return validateForm()" method="post">
                                  <?php
                                  if (isset($_POST['khachhang'])) {
                                    ...
                                    $query2 = "UPDATE phieuthu SET khachhang = '$khachhang' ,ngay = '$ngay' ,sotien='$sotien' ,ghichu='$ghichu'  WHERE id = $id";
                                  ...
                                  include_once './config/config.php';
                                  $conn = mysqli_connect($db_ip, $db_user, $db_password, $db_name);
                                  $query2 = "SELECT * FROM phieuthu WHERE id = '" . $id . "'";
                                  $result2 = mysqli_query($conn, $query2) or die(mysql_error());
                                  ...
                                  ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="khachhang" cclass="col-sm-3 control-label no-padding-right"
                                              ...
                                              <?php
                                              $conn = mysqli_connect($db_ip, $db_user, $db_password, $db_name);
                                              $query3 = "SELECT * FROM khachhang ORDER BY id";
                                              $result3 = mysqli_query($conn, $query3) or die(mysql_error());
                                              while ($rows3 = mysqli_fetch_array($result3)) {
                                                echo '<option value="' . $rows3['id'] . '">' . $rows3['makhachhang'] . '</option>';
                                              }
                                              ?></select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1-1" name="sotien"
                                                   value="<?php echo $rows2['sotien']; ?>" class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
        ...
        <script>
            function validateForm() {
                var x = document.forms["themcongnhan"]["makhachhang"].value;
                var y = document.forms["themcongnhan"]["tenkhachhang"].value;
                var a = document.forms["themcongnhan"]["thongtinlienhe"].value;
