                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form class="form-horizontal" role="form" name="themcongnhan"
                                      action="./edit_khachhang.php" onsubmit="return validateForm()" method="post">
                                  <?php
                                  if (isset($_POST['makhachhang'])) {
                                    ...
                                    $query2 = "UPDATE khachhang SET makhachhang = '$makhachhang' ,tenkhachhang = '$tenkhachhang' ,thongtinlienhe='$thongtinlienhe' WHERE id = $id";
                                  ...
                                  include_once './config/config.php';
                                  $conn = mysqli_connect($db_ip, $db_user, $db_password, $db_name);
                                  $query2 = "SELECT * FROM khachhang WHERE id = '" . $id . "'";
                                  $result2 = mysqli_query($conn, $query2) or die(mysql_error());
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1-1" name="makhachhang"
                                                   value="<?php echo $rows2['makhachhang']; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1-1" name="tenkhachhang"
                                                   value="<?php echo $rows2['tenkhachhang']; ?>"
                                                   class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1-1" name="thongtinlienhe"
                                                   value="<?php echo $rows2['thongtinlienhe']; ?>"
                                                   class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="space-4"></div>
