    ...
    <div class="col-xs-12">
            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form class="form-horizontal" role="form" name="edit_donhang"
                                      action="./edit_donhang.php" onsubmit="return validateForm()" method="post">
                                  <?php
                                  if (isset($_POST['mahang'])) {
                                    ...
                                    $query2 = "UPDATE donhang SET mahang = '$mahang' ,mahanggoc = '$mahanggoc' ,soluong='$soluong'  ,ngayxuat='$ngayxuat',trangthai='$trangthai'WHERE id = $id";
                                  ...
                                  include_once './config/config.php';
                                  $conn = mysqli_connect($db_ip, $db_user, $db_password, $db_name);
                                  $query2 = "SELECT * FROM donhang WHERE id = '" . $id . "'";
                                  $result2 = mysqli_query($conn, $query2) or die(mysql_error());
        ...
        <script>
            function validateForm() {
                var x = document.forms["edit_donhang"]["mahang"].value;
                var y = document.forms["edit_donhang"]["khachhang"].value;
                var a = document.forms["edit_donhang"]["soluong"].value;
                var b = document.forms["edit_donhang"]["dongia"].value;
                var c = document.forms["edit_donhang"]["ngayxuat"].value;
