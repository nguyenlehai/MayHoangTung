                ...
                <div class="row">
                   ...
                   values (?,?)";
                              ...
                              ?>
                                ...
                                <h5><b>Nhập báo cơm thủ công</b></h5>
                                <form class="form-horizontal" role="form" name="themkhachhang" action="./nhapbaocom.php"
                                  ...
                                  if (isset($_POST['macongnhan'])) {
                                    ...
                                    echo '<script type="text/javascript">
											...
											window.location.href = "nhapbaocom.php";
											</script>';
                                  }
                                  ?>
                                    <div class="form-group">
                                ...
                                <table>
                                    <tr>
                                        <td>
                                            <form action="nhapbaocom.php" class="register" method="get">
                    ...
                    <ul class="pagination pull-center no-margin">
                      ...
                      if (isset($ngay)) {
                        echo '><a href="nhapbaocom.php?page=';
