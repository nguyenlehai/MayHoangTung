                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form class="form-horizontal" role="form" name="themcongnhan"
                                      action="./edit_sanluongcongnhan.php" onsubmit="return validateForm()"
                                      method="post">
                                  <?php
                                  if (isset($_POST['congdoan'])) {
                                    $id = $_POST['id'];
                                    $mahang = $_POST['mahang'];
                                    ...
                                    $query2 = "UPDATE sanluongcongnhan SET congdoan = '$congdoan' ,sanluong='$sanluong' WHERE id = $id";
                                  ...
                                  include_once './config/config.php';
                                  $conn = mysqli_connect($db_ip, $db_user, $db_password, $db_name);
                                  $query2 = "SELECT * FROM sanluongcongnhan WHERE id = '" . $id . "'";
                                  $result2 = mysqli_query($conn, $query2) or die(mysql_error());
                                  ...
                                  ?>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Mã
                                            công nhân: <b> <?php echo $rows2['macongnhan']; ?></b></label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1-1" name="congdoan"
                                                   value="<?php echo $rows2['congdoan']; ?>"
