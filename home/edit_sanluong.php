    ...
    <div class="col-xs-12">
            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form class="form-horizontal" role="form" name="edit_sanluong"
                                      action="./edit_sanluong.php" onsubmit="return validateForm()" method="post">
                                  <?php
                                  if (isset($_POST['id'])) {
                                    $id = $_POST['id'];
                                    $bophan = $_POST['bophan'];
                                    ...
                                    $query2 = "UPDATE sanluong SET bophan = '$bophan' ,mahang='$mahang',ngay='$ngay',sanluong='$sanluong' WHERE id = $id";
                                  ...
                                  include_once './config/config.php';
                                  $conn = mysqli_connect($db_ip, $db_user, $db_password, $db_name);
                                  $query2 = "SELECT * FROM sanluong WHERE id = '" . $id . "'";
                                  $result2 = mysqli_query($conn, $query2) or die(mysql_error());
                                  ...
                                  ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1-1" name="ngay"
                                                   value="<?php echo $rows2['ngay']; ?>" class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="bophan" cclass="col-sm-3 control-label no-padding-right"
                                                    title="Bophan" required>
                                              <?php
                                              $conn = mysqli_connect($db_ip, $db_user, $db_password, $db_name);
                                              $query3 = "SELECT * FROM bophan ORDER BY id";
                                              $result3 = mysqli_query($conn, $query3) or die(mysql_error());
                                              while ($rows3 = mysqli_fetch_array($result3)) {
                                                echo '<option value="' . $rows3['id'];
                                                if ($rows2['bophan'] == $rows3['id']) {
                                                  echo '"selected="selected">' . $rows3['bophan'] . '</option>';
                                                } else {
                                                  echo '">' . $rows3['bophan'] . '</option>';
                                                }
                                              }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="mahang" cclass="col-sm-3 control-label no-padding-right"
                                              ...
                                              <?php
                                              $conn = mysqli_connect($db_ip, $db_user, $db_password, $db_name);
                                              $query3 = "SELECT * FROM donhang ORDER BY id DESC";
                                              $result3 = mysqli_query($conn, $query3) or die(mysql_error());
                                              while ($rows3 = mysqli_fetch_array($result3)) {
                                                echo '<option value="' . $rows3['id'];
                                                if ($rows2['mahang'] == $rows3['id']) {
                                                  echo '"selected="selected">' . $rows3['mahang'] . '</option>';
                                                } else {
                                                  echo '">' . $rows3['mahang'] . '</option>';
                                                }
                                              }
        ...
        <script>
            function validateForm() {
                var x = document.forms["edit_sanluong"]["macongnhan"].value;
                var y = document.forms["edit_sanluong"]["hovaten"].value;
                var a = document.forms["edit_sanluong"]["sodienthoai"].value;
                var b = document.forms["edit_sanluong"]["diachi"].value;
                var c = document.forms["edit_sanluong"]["cmnd"].value;
                var d = document.forms["edit_sanluong"]["bophan"].value;
