...
<div class="row">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form class="form-horizontal" role="form" name="themkhachhang"
                                      action="./themkhachhang.php" onsubmit="return validateForm()" method="post">
                                  <?php
                                  ...
                                  ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" autocomplete="off" id="form-field-1-1" name="makhachhang"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" autocomplete="off" id="form-field-1-1"
                                                   name="tenkhachhang" placeholder="Tên khách hàng"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" autocomplete="off" id="form-field-1-1"
                                                   name="thongtinlienhe" placeholder="Thông tin liên hệ"
                                                   class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="space-4"></div>
    ...
    <script>
        function validateForm() {
            var x = document.forms["themkhachhang"]["makhachhang"].value;
            var y = document.forms["themkhachhang"]["tenkhachhang"].value;
            var a = document.forms["themkhachhang"]["thongtinlienhe"].value;
            var b = document.forms["themkhachhang"]["diachi"].value;
            var c = document.forms["themkhachhang"]["cmnd"].value;
            var d = document.forms["themkhachhang"]["bophan"].value;
