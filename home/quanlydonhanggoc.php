                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <li>
                                    <a href="quanlydonhanggoc.php?loc=chuaxuat">Danh sách đơn hàng chưa xuất</a>
                                </li>
                                <li>
                                    <a href="quanlydonhanggoc.php?loc=daxuat">Danh sách đơn hàng đã xuất</a>
                                </li>
                                <li>
                                    <a href="quanlydonhanggoc.php">Tất cả đơn hàng</a>
                                </li>
                                <div class="clearfix">
                                ...
                                <div>
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        if (isset($_GET['loc'])) {
                                          ...
                                          $query = "SELECT * FROM donhanggoc WHERE trangthai = $loc ORDER BY id LIMIT $start,$limit DESC";
                                        } else {
                                          $query = "SELECT * FROM donhanggoc ORDER BY id LIMIT $start,$limit DESC";
                                        }
                                        $result = mysqli_query($conn, $query) or die(mysql_error());
                                        while ($row = mysqli_fetch_assoc($result)) {
                                          ...
                                          echo '</td>';
                                          echo '<td>';
                                          echo number_format($row['dongiachuyen'], 0);
                                          echo '</td>';
                                          echo '<td>';
                                          echo $row['mota'];
                                          echo '</td>';
                                          echo '<td>';
                                          echo $row['ngayvaochuyen'];
                                          echo '</td>';
                                          echo '<td>';
                                          echo $row['ngayxuat'];
                                          echo '</td>';
                                          ...
                                          echo '<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="green" href="edit_donhanggoc.php?id='; ?>
                                          <?php
                                          echo $row['id'];
                                          echo '">
                        ...
                        <ul class="pagination pull-center no-margin">
                          ...
                          while ($i < $sopage) {
                            ...
                            echo '><a href="quanlydonhanggoc.php?page=';
                            echo $i . '">' . $i;
                            echo '</a>';
                          }
                          ?>
                        ...
                        <form class="form-horizontal" role="form" name="quanlydonhanggoc"
                              action="./quanlydonhanggoc.php" onsubmit="return validateForm()" method="post">
                          <?php
                          if (isset($_POST['mahang'])) {
                            ...
                            include_once './config/config.php';
                            $conn = mysqli_connect($db_ip, $db_user, $db_password, $db_name);
                            $query2 = "INSERT INTO donhanggoc SET mahang = '$mahang' ,khachhang = '$khachhang' ,ngayvaochuyen='$ngayvaochuyen',dongia='$dongia',dongiachuyen='$dongiachuyen',soluong='$soluong'  ,ngayxuat='$ngayxuat',trangthai='$trangthai',mota='$mota',ghichu='$ghichu'";
                            $result2 = mysqli_query($conn, $query2) or die(mysql_error());
                            echo '<script type="text/javascript">
											alert("Thêm đơn hàng thành công");
											window.location.href = "quanlydonhanggoc.php";
											</script>';
                          }
                          ?>
                            <h2> Thêm đơn hàng </h2>
                            <table border="1">
                                <tr>
                                    ...
                                    <td>Số lượng</td>
                                    <td>Đơn giá</td>
                                    <td>Đơn giá xuống chuyền</td>
                                </tr>
                                <tr>
                                    <td><input type="text" name="mahang" placeholder="Mã hàng"/></td>
                                    <td>
                                        <select id="khachhang" name="khachhang" data-size="5" title="Chọn bộ phận"
                                                required>
                                          <?php
                                          include_once './config/config.php';
                                          $conn = mysqli_connect($db_ip, $db_user, $db_password, $db_name);
                                    ...
                                    <td>
                                        <input type="text" name="dongiachuyen" placeholder="Đơn giá xuống chuyền"/>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="ngayvaochuyen" placeholder="2020-01-31"/>
                                    </td>
                                    <td>
