    ...
    <div class="col-xs-12">
            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form class="form-horizontal" role="form" name="edit_donhanggoc"
                                      action="./edit_donhanggoc.php" onsubmit="return validateForm()" method="post">
                                  <?php
                                  if (isset($_POST['mahang'])) {
                                    ...
                                    $query2 = "UPDATE donhanggoc SET mahang = '$mahang' ,khachhang = '$khachhang' ,ngayvaochuyen='$ngayvaochuyen',dongia='$dongia',dongiachuyen='$dongiachuyen',soluong='$soluong'  ,ngayxuat='$ngayxuat',trangthai='$trangthai',mota='$mota',ghichu='$ghichu' WHERE id = $id";
                                  ...
                                  include_once './config/config.php';
                                  $conn = mysqli_connect($db_ip, $db_user, $db_password, $db_name);
                                  $query2 = "SELECT * FROM donhanggoc WHERE id = '" . $id . "'";
                                  $result2 = mysqli_query($conn, $query2) or die(mysql_error());
                                  ...
                                  ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1-1" name="mahang"
                                                   value="<?php echo $rows2['mahang']; ?>" class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1-1" name="soluong"
                                                   value="<?php echo $rows2['soluong']; ?>" class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1-1" name="dongia"
                                                   value="<?php echo $rows2['dongia']; ?>" class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1-1" name="dongiachuyen"
                                                   value="<?php echo $rows2['dongiachuyen']; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1-1" name="mota"
                                                   value="<?php echo $rows2['mota']; ?>" class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1-1" name="ghichu"
                                                   value="<?php echo $rows2['ghichu']; ?>" class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1-1" name="ngayvaochuyen"
                                                   value="<?php echo $rows2['ngayvaochuyen']; ?>"
                                                   class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1-1" name="ngayxuat"
                                                   value="<?php echo $rows2['ngayxuat']; ?>"
                                                   class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="space-4"></div>
        ...
        <script>
            function validateForm() {
                var x = document.forms["edit_donhanggoc"]["mahang"].value;
                var y = document.forms["edit_donhanggoc"]["khachhang"].value;
                var a = document.forms["edit_donhanggoc"]["soluong"].value;
                var b = document.forms["edit_donhanggoc"]["dongia"].value;
                var c = document.forms["edit_donhanggoc"]["ngayxuat"].value;
