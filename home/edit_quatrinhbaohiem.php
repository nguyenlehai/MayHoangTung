    ...
    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form class="form-horizontal" role="form" name="themcongnhan"
                                      action="./edit_quatrinhbaohiem.php" onsubmit="return validateForm()"
                                      method="post">
                                  <?php
                                  if (isset($_POST['macongnhan'])) {
                                    ...
                                    $query2 = "UPDATE baohiem SET macongnhan = '$macongnhan' ,batdau = '$batdau' ,ketthuc='$ketthuc' WHERE id = $id";
                                  ...
                                  include_once './config/config.php';
                                  $conn = mysqli_connect($db_ip, $db_user, $db_password, $db_name);
                                  $query2 = "SELECT * FROM baohiem WHERE id = '" . $id . "'";
                                  $result2 = mysqli_query($conn, $query2) or die(mysql_error());
        ...
        <script>
            function validateForm() {
                ...
                var y = document.forms["themcongnhan"]["batdau"].value;
