            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="header smaller lighter blue">Báo cáo sản lượng</h3>
                                <table>
                                    <tr>
                                        <td>
                                            <form class="form-horizontal" role="form" name="chonchuyen"
                                                  action="./quanlysanluong.php" onsubmit="return validateForm()"
                                                  method="get">
                                        ...
                                        <td>
                                            <button onclick="window.location.href='quanlysanluong.php'">
                                                Hiển thị tất cả
                                            </button>
                                        </td>
                                    </tr>
                                ...
                                <div>
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th>Tổng luỹ kế</th>
                                            <th>Tổng đơn hàng</th>
                                            <th class="hidden-480">Ngày xuất kế hoạch</th>
                                        ...
                                        if (isset($_GET['bophan'])) {
                                          $bophan = $_GET['bophan'];
                                          $query = "SELECT * FROM sanluong WHERE bophan = '$bophan' ";
                                        } else {
                                          $query = "SELECT * FROM sanluong";
                                        }
                                        ...
                                        $conn = mysqli_connect($db_ip, $db_user, $db_password, $db_name);
                                        if (isset($_GET['bophan'])) {
                                          $query = "SELECT * FROM sanluong WHERE bophan = '$bophan' ORDER BY id DESC LIMIT $start,$limit";
                                        } else {
                                          $query = "SELECT * FROM sanluong ORDER BY id DESC LIMIT $start,$limit";
                                        }
                                        $result = mysqli_query($conn, $query) or die(mysql_error());
                                        while ($row = mysqli_fetch_assoc($result)) {
                                          ...
                                          echo '<td>';
                                          $conn = mysqli_connect($db_ip, $db_user, $db_password, $db_name);
                                          $query4 = "SELECT sum(sanluong) FROM sanluong WHERE mahang = '" . $row['mahang'] . "'";
                                          $result4 = mysqli_query($conn, $query4) or die(mysql_error());
                                          while ($row4 = mysqli_fetch_assoc($result4)) {
                                            $luyke = $row4['sum(sanluong)'];
                                          }
                                          ...
                                          echo '<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="green" href="edit_sanluong.php?id='; ?>
                                          <?php
                                          echo $row['id'];
                                          echo '">
                        ...
                        <ul class="pagination pull-center no-margin">
                          ...
                          if (isset($bophan)) {
                            echo '><a href="quanlysanluong.php?page=';
                            echo $trangtruoc . '&bophan=' . $bophan . '">Trang trước</a>';
                          } else {
                            echo '><a href="quanlysanluong.php?page=';
                          ...
                          if (isset($bophan)) {
                            echo '><a href="quanlysanluong.php?page=';
                            echo $trangsau . '&bophan=' . $bophan . '">Trang sau</a>';
                          } else {
                            echo '><a href="quanlysanluong.php?page=';
