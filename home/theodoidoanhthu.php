                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                              ...
                              echo '<h3 class="header smaller lighter blue">Tổng hợp doanh thu: tháng ' . $month . '/' . $year . '</h3>';
                              ...
                              ?>
                                ...
                                <div>
                                    <table id="dynamic-table" name="tonghop"
                                        ...
                                        $doanhthungay = 0;
                                        $tongdoanhthu = 0;
                                        $query = "SELECT * FROM sanluong WHERE ngay >='$dauthang' AND ngay <='$cuoithang' ORDER BY ngay DESC, bophan";
                                        $result = mysqli_query($conn, $query) or die(mysql_error());
                                        while ($row = mysqli_fetch_assoc($result)) {
                                          $dem = $dem + 1;
                                          $bophan = $row['bophan'];
                                          $ngay = $row['ngay'];
                                          $query5 = "SELECT * FROM sanluong WHERE ngay = '$ngay'";
                                          $result5 = mysqli_query($conn, $query5) or die(mysql_error());
                                          $sochuyen = mysqli_num_rows($result5);
                                          echo '<tr>';
                                          echo '<td>';
                                          if ($dem == 1) {
                                            echo '<b>' . $ngay . '</b>';
                                          ...
                                          echo '</td>';
                                          echo '<td>';
                                          $doanhthu = $row['sanluong'] * $dongia;
                                          echo number_format($doanhthu, 0);
                                          echo '</td>';
                                          echo '<td>';
                                          if ($theodoi == $row['ngay']) {
                                            $doanhthungay = $doanhthungay + $doanhthu;
                                          } else {
                                            $theodoi = $row['ngay'];
                                            $doanhthungay = $doanhthu;
                                          }
                                          if ($dem == $sochuyen) {
                                            echo '<b>' . number_format($doanhthungay, 0) . '</b>';
                                            $dem = 0;
                                            $tongdoanhthu = $tongdoanhthu + $doanhthungay;
                                          }
                                          echo '</td>';
                                          echo '</tr>';
                                        }
                                        ...
                                        <h5>Tổng doanh thu tháng: <?php echo number_format($tongdoanhthu, 0); ?></h5>
                                    </table>
                                    <button id="btnExport" onclick="fnExcelReport();"> Xuất ra excel</button>
                                </div>
                            </div>
                        ...
                        <ul class="pagination pull-center no-margin">
                          ...
                          echo '<li class="active"><a href="theodoidoanhthu.php?y=' . $yearn . '&m=' . $monthn . '">Tháng trước</a>';
                          ?>
                          <?php
                          if ($month == 12) {
                            $monthn = 1;
                          ...
                          echo '  <li class="active"><a href="theodoidoanhthu.php?y=' . $yearn . '&m=' . $monthn . '">Tháng kế tiếp</a>';
                          ?>
                        </ul>
