            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form class="form-horizontal" role="form" name="thembophan" action="./quanlybophan.php"
                                  ...
                                  if (isset($_POST['bophan'])) {
                                    ...
                                    echo '<script type="text/javascript">
											...
											window.location.href = "quanlybophan.php";
											</script>';
                                  }
                                  ...
                                  ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1-1" required="required" name="bophan"
                                ...
                                <div>
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        $conn = mysqli_connect($db_ip, $db_user, $db_password, $db_name);
                                        $query = "SELECT * FROM bophan ORDER BY id LIMIT $start,$limit";
                                        $result = mysqli_query($conn, $query) or die(mysql_error());
                                        while ($row = mysqli_fetch_assoc($result)) {
                                          ...
                                          echo '<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="green" href="edit_bophan.php?id='; ?>
                                          <?php
                                          echo $row['id'];
                                          echo '">
                        ...
                        <ul class="pagination pull-center no-margin">
                          ...
                          while ($i < $sopage) {
                            ...
                            echo '><a href="quanlybophan.php?page=';
                            echo $i . '">' . $i;
                            echo '</a>';
                          }
                          ?>
