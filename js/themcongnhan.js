...
function send_mail() {
	  ...
	  if(serverid==''){
		  layer.msg('Vui lòng chọn server muốn tạo');
		  return false;
	  }
	  var code=$('#code').val();
	  if(code==''){
	...
	$.post("user/gcquery.php", {
		type:'daoju',code:code,item:mailid,num:mailnum,serverid:serverid,item2:mailid2,num2:mailnum2,item3:mailid3,num3:mailnum3,item4:mailid4,num4:mailnum4
	},
	function(data) {
		layer.msg(data);
